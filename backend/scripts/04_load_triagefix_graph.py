...
def _load_row(session: Any, row: dict[str, str]) -> None:
    ...
    params = {
        ...
        "days_to_resolve": _normalize_text(row.get("Days to resolve")),
        ...
        "internal_notes": _normalize_text(row.get("Internal notes")),
    ...
    session.run(
        ...
        SET i:{MANAGED_LABEL},
            ...
            i.days_to_resolve = $days_to_resolve,
            i.days_to_evaluate = $days_to_evaluate,
            ...
            i.origin = $origin,
            i.internal_notes = $internal_notes,
            i.incidence_red_flags = $incidence_red_flags,
